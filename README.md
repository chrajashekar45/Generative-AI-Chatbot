...
>>Designed an interactive UI using Streamlit, enabling users to:
       Select AI models via sidebar dropdown
       Adjust response creativity (temperature: 0.0–1.0) and length (50–300 tokens)
       Input natural language queries through chat interface

>>Implemented Langsmith tracing for monitoring AI interactions and debugging.
>>Configured environment variables for secure API key management using Python-dotenv.
